...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
	 ...
	 question2 = new JLabel("<html>Which celebrity isn't in a relationship? <br> A: Taylor Swift <br> B: Kin Kardashian <br> C: Blake Shelton  </html>");
	
	 question3 = new JLabel("<html>How many people watched stranger things the day it came out? <br> A: 30,000 <br> B: 361,000 <br> C: 2,000  </html>");
	}
